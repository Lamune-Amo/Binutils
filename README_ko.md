...
**AMO architecture**를 위한 GNU binutils의 포팅입니다. (`as`, `ld`, `objdump`, `objcopy`, ...을 제공합니다.)
...
`as`를 통해 위 코드를 assemble할 수 있습니다. `objdump`를 통해 확인하면 아래처럼 볼 수 있습니다.
